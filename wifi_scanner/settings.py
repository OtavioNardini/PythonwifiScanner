"""
Django settings for wifi_scanner project.
...
SECRET_KEY = 'django-insecure-bjl*f!svmhwjv31ruvz=s9$2c@ma+0#bi*700#i21+z*faz0!c'
...
ROOT_URLCONF = 'wifi_scanner.urls'
...
WSGI_APPLICATION = 'wifi_scanner.wsgi.application'
...
# Defina o caminho para os arquivos de tradução
LOCALE_PATHS = [
    BASE_DIR / 'locale',
]
